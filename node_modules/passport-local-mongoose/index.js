console.log('node_modules/passport-local-mongoose/index.js')
...
module.exports = function(schema, options) {
  ...
  options.profileField = options.profileField || 'profile';
  console.log('options.profileField='+options.usernameField);
  console.log('options.profileField='+options.profileField); //Sekhar
  ...
  schema.statics.register = function(user, password, profile, cb) {
    ...
    self.findByUsername(user.get(options.usernameField), function(err, existingUser) {
      ...
      user.setPassword(password, function(setPasswordErr, user) {
        ...
        //Setting Profile
        user.set(options.profileField, profile);
        user.save(function(saveErr) {
          if (saveErr) {
            return cb(saveErr);
          }
